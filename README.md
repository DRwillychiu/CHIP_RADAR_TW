...
> **當前版本**:v3.77.0(2026-08-30) ｜ **網站**:https://drwillychiu.github.io/CHIP_RADAR_TW/
...
| **v3.73.1** | 8/4 | crawler enrich log 措辭修正 — 原「N stocks matched (蔣承翰為 top #1)」把「取得榜單檔數」誤寫成「他拿 #1 的檔數」(今日 24 vs 實際 2); 改為分開列出 + 顯示富邦/histock 來源分佈 |
